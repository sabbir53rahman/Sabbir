      ...
      <motion.div style={{ y, opacity }} className="text-center z-10 max-w-6xl mx-auto px-4">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            />
            <h2 className="text-2xl md:text-4xl text-gray-300 font-light tracking-wider">Full Stack MERN Developer</h2>
            <motion.div
              animate={{ rotate: -360 }}
              transition={{ duration: 8, repeat: Number.POSITIVE_INFINITY, ease: "linear" }}
        ...
        >
          Crafting digital experiences with <span className="text-purple-400 font-semibold">modern technologies</span>.
          I transform ideas into beautiful, functional applications that make a{" "}
          <span className="text-pink-400 font-semibold">real difference</span>.
        </motion.p>
